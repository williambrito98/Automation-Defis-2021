...
async function run() {
  ...
  try {
    ...
    for (let index = 0; index < Object.keys(configJson).length; index++) {
      ...
      await page_2.waitForSelector(
        "#ctl00_MenuApln0 > table > tbody > tr > td > a"
      );
      await page_2.click("#ctl00_MenuApln0 > table > tbody > tr > td > a");
      await page_2.waitForSelector("#ctl00_conteudo_AnoCalendario");
      await page_2
        .click("#ctl00_conteudo_AnoCalendario")
        .then((item) => console.log("retificado"));
      await page_2
        .click("#ctl00_conteudo_AnoRetCalendario")
        .then((item) => console.log("original"));
      await page_2.click("#ctl00_conteudo_lnkContinuar");
      await page_2.waitForSelector("#ctl00_conteudo_TrvDASNt1");
      const numerButtons = await page_2.$$eval(
        "#ctl00_conteudo_TrvDASN > table",
        (item) => item.length
      );
      if (numerButtons == 3) {
      ...
      await page_2.type(
        ...
        configJson[cliente].qtd_empregados_inicio.toString()
      );
      await page_2.type(
        "#ctl00_conteudo_InfEconEmpConteudo > div:nth-child(3) > input",
        configJson[cliente].qtd_empregados_fim.toString()
      );
      await page_2.type(
        "#ctl00_conteudo_InfEconEmpConteudo > div:nth-child(4) > input",
        configJson[cliente].lucro_contabil.toString()
      );
      await page_2.type(
      ...
      for (let index = 0; index < configJson[cliente].socios.length; index++) {
        ...
        await page_2.type(
          ...
          configJson[cliente].socios[index].cpf
        );
        await page_2.type(
          `#ctl00_conteudo_InfEconEmpConteudo > div:nth-child(7) > div:nth-child(${
            index + 2
          }) > div.conteudo > div:nth-child(1) > input`,
          configJson[cliente].socios[index].rendimento
        );
        await page_2.type(
          `#ctl00_conteudo_InfEconEmpConteudo > div:nth-child(7) > div:nth-child(${
            index + 2
          }) > div.conteudo > div:nth-child(2) > input`,
          configJson[cliente].socios[index].prolabore
        );
        await page_2.type(
          `#ctl00_conteudo_InfEconEmpConteudo > div:nth-child(7) > div:nth-child(${
            index + 2
          }) > div.conteudo > div:nth-child(3) > input`,
          configJson[cliente].socios[index].participacao_socio.replace("%", "")
        );
        await page_2.type(
          `#ctl00_conteudo_InfEconEmpConteudo > div:nth-child(7) > div:nth-child(${
            index + 2
          }) > div.conteudo > div:nth-child(4) > input`,
          configJson[cliente].socios[index].irrf
        );
      ...
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(1) > input`,
        "0"
      );
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(2) > input`,
        "0"
      );
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(3) > input`,
        configJson[cliente].saldo_caixa_inicio.toString()
      );
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(4) > input`,
        configJson[cliente].saldo_caixa_fim.toString()
      );
      await page_2.type(`#txt_item5_interno`, "0");
      await page_2.type(`#txt_item5_import`, "0");
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(6) > input`,
        "0"
      );
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(7) > input`,
        "0"
      );
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(8) > input`,
        "0"
      );
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(9) > input`,
        "0"
      );
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(10) > input`,
        "0"
      );
      await page_2.type(
        `#ctl00_conteudo_ief${configJson[cliente].cpf_cnpj}Conteudo > div:nth-child(11) > input`,
        configJson[cliente].total_despesas.toString()
      );
      await page_2.click(
        "#ctl00_conteudo_tbloptMundacaEndereco tr:nth-child(3) td:nth-child(2) input"
      );
      await page_2.click(
        "#pnlTemplateMundancaEnderecoCabecTexto center input:nth-child(2)"
      );
      await page_2.waitForTimeout(15000);
      await page_2.click("#ctl00_MenuApln0 > table > tbody > tr > td > a");
      await page_2.waitForSelector(
        "#ctl00_MenuApln1 > table > tbody > tr > td > a"
      );
      ...
      await page_2.click("#ctl00_MenuApln0 > table > tbody > tr > td > a");
      await page_2.waitForTimeout(2000);
      lengthTable = await page_2.$$eval(
        "#ctl00_conteudo_TabDeclaracoes > tbody tr",
        (item) => item.length
      );
      await page_2.waitForTimeout(1000);
      await page_2.click(
        `#ctl00_conteudo_TabDeclaracoes > tbody tr:nth-child(${lengthTable}) td:nth-child(5) a`
      );
      await page_2.waitForTimeout(2000);
      await renameFileDownload(fs, path, pathDownload, cliente);
      delete configJson[cliente];
...
(async () => {
  ...
  do {
    ...
    if (robo == false) {
      if (tentativas == 3) {
        fs.appendFileSync(pathJsonErrors, JSON.stringify(configJson[cliente]), {
          flag: "a",
        });
        delete configJson[cliente];
      } else {
